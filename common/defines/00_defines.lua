...
NBuildings = {
	...
	AIRBASE_CAPACITY_MULT = 25,		-- Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
...
NIntel = {
	...
	RECON_INTEL_BONUS = 0.095,                                      -- each recon gives this bonus to overall gathered land intel in combat
	...
	INTEL_NETWORK_MAX_CIVILIAN_INTEL = 95.0, -- was 20.0
	INTEL_NETWORK_MAX_ARMY_INTEL = 95.0, -- was 20.0
	INTEL_NETWORK_MAX_NAVY_INTEL = 100.0,				-- was 25.0  / only apply if the network encompass a naval base controlled by the network's target
	INTEL_NETWORK_MAX_AIRFORCE_INTEL = 100.0, -- was 15.0
