...
NBuildings = {
	...
	RADAR_RANGE_BASE = 300,				-- Radar range base, first level radar will be this + min, best radar will be this + max
	RADAR_RANGE_MIN = 300,				-- Radar range (from state center to province center) in measure of map pixels. Exluding techs.
