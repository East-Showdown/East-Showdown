...
NDefines.NRaids.RAID_DEFAULT_TARGET_COOLDOWN_DAYS = 3
NDefines.NRaids.RAID_MEDIUM_RISK_SETTING_DISASTER_MODIFIER = 0.15 --0.1
NDefines.NRaids.RAID_HIGH_RISK_SETTING_DISASTER_MODIFIER = 0.40 --0.25
...
NDefines.NRaids.RAID_OUTCOME_REPORT_DAYS_TO_LIVE = 3 -- 30
